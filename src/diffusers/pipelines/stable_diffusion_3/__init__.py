...
try:
    ...
    _import_structure["pipeline_stable_diffusion_3_diverse"] = ["StableDiffusion3DiversePipeline"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .pipeline_stable_diffusion_3_diverse import StableDiffusion3DiversePipeline
